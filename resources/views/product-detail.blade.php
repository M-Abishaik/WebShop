		...
		<li> <a class="totalInCart" href="/cart"><strong>Total Amount  <span class="badge badge-warning pull-right" style="line-height:18px;">$448.42</span></strong></a></li>
			...
			<li>
			  <div class="thumbnail">
				...
				<img src=" {{ url('/img/bootstrap-ecommerce-templates.png') }}">
				<div class="caption">
			...
			<li>
			  <div class="thumbnail">
				<a class="zoomTool" href="/productDetails" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				<img src=" {{ url('/img/shopping-cart-template.png') }}">
				<div class="caption">
				  <h4><a class="defaultBtn" href="/productDetails">VIEW</a> <span class="pull-right">$22.00</span></h4>
				</div>
			  </div>
			...
			<li>
			  <div class="thumbnail">
				<a class="zoomTool" href="/productDetails" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				<img src=" {{ url('/img/bootstrap-template.png') }}">
				<div class="caption">
				  <h4><a class="defaultBtn" href="/productDetails">VIEW</a> <span class="pull-right">$22.00</span></h4>
				</div>
			  </div>
			...
			<div id="myCarousel" class="carousel slide cntr">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="#"> <img src=" {{ url('/img/a.jpg') }}" alt="" style="width:100%"></a>
                  </div>
                  <div class="item">
                     <a href="#"> <img src="{{ url('/img/b.jpg') }}" alt="" style="width:100%"></a>
                  </div>
                  <div class="item">
                    <a href="#"> <img src=" {{ url('/img/e.jpg') }}" alt="" style="width:100%"></a>
                  </div>
                </div>
